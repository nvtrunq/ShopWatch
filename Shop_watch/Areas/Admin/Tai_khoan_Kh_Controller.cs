...
namespace Shop_watch.Areas.Admin
{
    public class Tai_khoan_Kh_Controller : Controller
    {
        private Shop_watchEntities db = new Shop_watchEntities();

        // GET: Admin/Tai_khoan_Kh_
        public ActionResult Index()
        {
            return View(db.Tai_khoan_Kh.ToList());
        }

        // GET: Admin/Tai_khoan_Kh_/Details/5
        ...
        // GET: Admin/Tai_khoan_Kh_/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Admin/Tai_khoan_Kh_/Create
        ...
        // GET: Admin/Tai_khoan_Kh_/Edit/5
        ...
        // POST: Admin/Tai_khoan_Kh_/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Admin/Tai_khoan_Kh_/Delete/5
        ...
        // POST: Admin/Tai_khoan_Kh_/Delete/5
