...
namespace Shop_watch.Areas.Admin.Controllers
{
    public class Tai_khoan_KhController : Controller
    {
        ...
        // GET: Admin/Tai_khoan_Kh
        public ActionResult Index()
        {
            return View(db.Tai_khoan_Kh.ToList());
        }

        // GET: Admin/Tai_khoan_Kh/Details/5
        ...
        // GET: Admin/Tai_khoan_Kh/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Admin/Tai_khoan_Kh/Create
        ...
        // POST: Admin/Tai_khoan_Kh/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Admin/Tai_khoan_Kh/Delete/5
        ...
        // POST: Admin/Tai_khoan_Kh/Delete/5
